...
# install
url --url https://repo.almalinux.org/almalinux/8.6/BaseOS/$basearch/kickstart/
repo --name=BaseOS --baseurl=https://repo.almalinux.org/almalinux/8.6/BaseOS/$basearch/os/
repo --name=AppStream --baseurl=https://repo.almalinux.org/almalinux/8.6/AppStream/$basearch/os/
